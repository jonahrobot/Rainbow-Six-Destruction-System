...
bool WallCutter_TwoSquaresOverlap::RunTest(const FString& Parameters) {
	...
	TestWallCutter::CutTestCase x{
		...
		"(2,2),(2,0),(0,0),(0,2)",										// Cut Wall in
		"(1,1),(1,0,ENTRY),(1,-1),(-1,-1),(-1,1),(0,1,EXIT)",			// Wall Out
		"(2,2),(2,0),(1,0,ENTRY),(0,0),(0,1,EXIT),(0,2)",				// Cut Out
		{																// Regions out
			"(1,0,ENTRY),(1,-1),(-1,-1),(-1,1),(0,1,EXIT),(0,0)"
		}
	};
...
bool WallCutter_RectangleSplitTest::RunTest(const FString& Parameters) {
	...
	TestWallCutter::CutTestCase x{
		...
		"(1,1),(1,-1),(0.5,-1,EXIT),(-0.5,-1,ENTRY),(-1,-1),(-1,1),(-0.5,1,EXIT),(0.5,1,ENTRY)",			// Wall Out
		"(0.5,2),(0.5,1,ENTRY),(0.5,-1,EXIT),(0.5,-2),(-0.5,-2),(-0.5,-1,ENTRY),(-0.5,1,EXIT),(-0.5,2)",	// Cut Out
		{																									// Regions out	
			"(0.5,1,ENTRY),(1,1),(1,-1),(0.5,-1,EXIT)", 
			"(-0.5,-1,ENTRY),(-1,-1),(-1,1),(-0.5,1,EXIT)"
		}
	};
...
bool WallCutter_ExtrudeTest::RunTest(const FString& Parameters) {
	...
	FJsonSerializableArrayInt expectedTriangles = { 0,1,24,1,2,24,2,3,24,3,4,24,4,5,24,5,6,24,6,7,24,7,8,24,9,
		9,8,9,9,8,9,12,8,12,13,8,13,14,8,14,15,8,15,16,8,20,21,19,21,22,19,22,23,19,24,8,23,8,16,23,16,17,23,17
		,18,23,18,19,23,49,26,25,49,27,26,49,28,27,49,29,28,49,30,29,49,31,30,49,32,31,49,33,32,33,34,34,33,34,
		34,33,37,34,33,38,37,33,39,38,33,40,39,33,41,40,44,46,45,44,47,46,44,48,47,48,33,49,48,41,33,48,42,41,48
		,43,42,48,44,43,24,25,0,25,24,49,0,26,1,26,0,25,1,27,2,27,1,26,2,28,3,28,2,27,3,29,4,29,3,28,4,30,5,30,4
		,29,5,31,6,31,5,30,6,32,7,32,6,31,7,33,8,33,7,32,8,34,9,34,8,33,9,35,10,35,9,34,10,36,11,36,10,35,11,37
		,12,37,11,36,12,38,13,38,12,37,13,39,14,39,13,38,14,40,15,40,14,39,15,41,16,41,15,40,16
		,42,17,42,16,41,17,43,18,43,17,42,18,44,19,44,18,43,19,45,20,45,19,44,20,46,21,46,20,45,21,47,22,47,21,46,22,48,23,48,22,47,23,49,24,49,23,48
	};
